 ...
 * record against the header: its name and length always, and its MD5 wherever the header
 * declares one. A re-ordered FASTA fails immediately, and a substituted one fails wherever
 * there is a checksum to catch it.
 *
