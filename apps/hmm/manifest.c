...
static const fmt_written WRITTEN[] = {
    ...
    { .id = FMT_PRIMARY_COUNTED,
      .how = "The number of primary reads the HMM successfully processed." },
    { .id = FMT_PRIMARY_REJECTED,
      .how = "The number of primary reads rejected by a filter or by the HMM." },
    { .id = FMT_SUPPLEMENTARY_COUNTED,
      .how = "The number of supplementary reads the HMM successfully processed." },
    { .id = FMT_SUPPLEMENTARY_REJECTED,
      .how = "The number of supplementary reads rejected by a filter or by the HMM." },
    { .id = FMT_UNMAPPED,
